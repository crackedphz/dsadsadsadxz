...
module.exports = client => {
    ...
    client.on("messageCreate", async (message) => {
        if(message.guild && !message.author.bot) {
            ...
            client.modmailDb.ensure(message.guild.id, {
                enabled: false,
                category: null,
                message: "Aguarde alguem da Staff ver suas mensagem."
            })
            ...
            if(prefixRegex.test(message.content)) {
                ...
                if(cmd.length == 0 && matchedPrefix.includes(client.user.id)){
                    return message.reply({embeds: [
                        new Discord.MessageEmbed().setColor("BLACK").setTitle(`:white_check_mark: **Envie uma mensagem na minha dm !**`)
                    ]}).catch(console.error);
                }
                if(cmd && cmd.length > 0){
                    if(cmd == "invitetysdfsf56yfytry " || cmd == "add"){
                        message.reply({
                            ...
                            return message.reply({
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                        .setColor("RED")
                                        .setTitle("FORMA ERRADA!")
                                        .setDescription(`Use: \`${config.prefix}configurar <CategoriaId> \`\n**CategoriaId**... \n**Mensagem**... é a Mensagem que deve ser enviada para o DMS assim que o TICKET/MODMAIL for aberto!!`)
                                ]
                            }).catch(console.error)
                        }
                        ...
                        client.modmailDb.set(message.guild.id, {
                            ...
                            message: args[1] ? args.slice(1).join(" ").substr(0, 2000) : "Aguarde alguém da Staff ver suas mensagem..."
                        })
                        return message.reply({
                            embeds: [
                                new Discord.MessageEmbed()
                                    ...
                                    .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                    .setColor("GREEN")
                                    .setTitle("✅ Configurado com sucesso ")
                                ]
                        }).catch(console.error)
                    } 
                    else if(cmd == "deleteconfigurar"){
                        if(!message.member.permissions.has(Discord.Permissions.FLAGS.ADMINISTRATOR)) {
                            return message.reply({
                                embeds: [
                                    new Discord.MessageEmbed()
                            ...
                            return message.reply({
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                        .setColor("GREEN")
                                        .setTitle("✅ Forçar fechamento desse ticket")
                                        .setDescription(`Agora você pode excluir , se quiser !`)
                                    ]
                            }).catch(console.error)
                        } else {
                            return message.reply({
                            ...
                            return message.reply({
                                    embeds: [
                                        new Discord.MessageEmbed()
                                            ...
                                            .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                            .setColor("RED")
                                            .setTitle("❌ Este Canal está Fechado / o usuário saiu! ")
                                            .setDescription(`Feche o ticket com: \`${config.prefix}fecharticket\`\nDepois disso, você pode excluir o canal!`)
                                        ]
                                }).catch(console.error);
                                ...
                                return message.reply({
                                    embeds: [
                                        new Discord.MessageEmbed()
                                            ...
                                            .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                            .setColor("RED")
                                            .setTitle("❌ O usuário saiu do servidor")
                                            .setDescription(`Feche o ticket com: \`${config.prefix}fecharticket\``)
                                        ]
                                }).catch(console.error)
                            })
                            ...
                            await author.send({
                                ...
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                        .setColor("GREEN")
                                        .setTitle("✅  alguem  da Staff fechou seu ticket.")    
                                    ]
                            }).catch(console.error)
                            ...
                            return message.reply({
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                        .setColor("RED")
                                        .setTitle("❌ Esse canal não e de ticket !")
                                    ]
                            }).catch(console.error)
                        }
                    } else if(cmd == "si9sdja9i3j3te4trte4twert4ete4tet ") {
                        let { guild } = message
                        let embeds = []
                        embeds.push(new Discord.MessageEmbed()
                            .setColor("BLURPLE")
                            .setTitle(`Seja bem vindo !`)
                            .setDescription(`Olá , eu sou um modmaill`)
            ...
            if(data.category == message.channel.parentId){
                ...
                return message.reply({
                        embeds: [
                            new Discord.MessageEmbed()
                                ...
                                .setDescription(`Feche seu ticket com: \`${config.prefix}fecharticket\`\nDepois você pode excluir o canal!`)
                            ]
                    }).catch(console.error);
                let author = message.guild.members.cache.get(authorId);
                if(!author)
                    ...
                    return message.reply({
                        embeds: [
                            new Discord.MessageEmbed()
                                ...
                                .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                .setColor("RED")
                                .setTitle("❌ O usuario saiu do servidor")
                                .setDescription(`Close the Ticket with: \`${config.prefix}fecharticket\``)
                            ]
                    }).catch(console.error)
                })
                if(!author){
                ...
                .setAuthor(serverauthor.tag, serverauthor.displayAvatarURL({dynamic: true}))
                .setTimestamp()
                .addField(`Atenção:`, `Horário de atendimento: Segunda a domingo, 10:30 as 01:00 da noite`, serverauthor.displayAvatarURL({dynamic: true}))
                .setColor("BLACK")
                .setTitle(" ")
                .setDescription(`**Atendente**: ${message.content}`.substr(0, 2048));
                ...
                author.send({
                    ...
                    return message.reply({
                        embeds: [
                            ...
                            .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                            .setColor("BLACK")
                            .setTitle("❌ Falha ao mandar mensagem no canal")
                            .setDescription(`\`\`\`${error.message ? String(error.message).substr(0, 2000) : String(e).substr(0, 2000)}\`\`\``)
                           ]
                    }).catch(console.error)
                })
                .then(success=>{
                    message.react("<a:Typing:1003560801505923082>").catch(console.error)
                });
            }
    ...
    client.on("ready", () => {
        client.user.setActivity({
            name: "Mande-me uma mensagem | " + client.guilds.cache.size + "  Servidores", type: "PLAYING", url: "https://twitch.tv/#"
        })
        setInterval(() => {
            client.user.setActivity({
                name: "Mande-me uma mensagem | " + client.guilds.cache.size + "  Servidores", type: "PLAYING", url: "https://twitch.tv/#"
        ...
        if(!message.guild || message.channel.type == "DM") {
            ...
            if(!client.modmailDb.has(dmauthor.id)){
                ...
                if(guildsin.length == 0){
                        ...
                        message.reply({
                            embeds: [
                                new Discord.MessageEmbed()
                                    ...
                                    .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                                    .setColor("RED")
                                    .setTitle("❌ Não foi possível encontrar o servidor com este ID!! (SELECIONE O ID DO SERVIDOR QUE VOCÊ DESEJA !)")
                            ]
                        }).catch(console.error)
                    ...
                    let embed = new Discord.MessageEmbed()
                        ...
                        .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                        .setColor("BLACK")
                        .setTitle("✅ Todos servidores que tem o bot !")
                        .setDescription(String(guildsin.map(id => `${client.guilds.cache.get(id) ? `**${client.guilds.cache.get(id).name}** (\`${id}\`)`: `\`${id}\``}`).join("\n")).substr(0, 2048))
                        .setFooter("Informação: Selecione o id do servidor que você deseja ter o **suporte**")
                    message.reply({
                        embeds: [
                            embed,
                            new Discord.MessageEmbed()
                                ...
                                .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                                .setColor("BLACK")
                                .setTitle("👍 Selecione o canal de Suporte!")
                                .setDescription(`Por favor use o id \`${guildsin[0]}\``)
                        ]
                    });
                }
            }
            //SUPPORT MESSAGES ETC.            
                    ...
                    return message.reply({
                        embeds: [
                            new Discord.MessageEmbed()
                                ...
                                .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                                .setColor("RED")
                                .setTitle("❌ Não foi possivel enviar a mensagem , tente novamente")
                            ]
                    }).catch(console.error)
                }
                ...
                let embed = new Discord.MessageEmbed()
                    ...
                    .setColor("BLACK")
                    .setTitle(" ")
                    .setDescription(`**Cliente**: ${message.content}`.substr(0, 2048))
                if(attachment.length > 0){
                    console.log(attachment)
                    embed.setImage('attachment://unknown.png');
                }
    ...
    client.on("interactionCreate", async interaction => {
        if(interaction.isButton() && interaction.customId == "close_modmail_ticket" && !interaction.guildId){
            ...
            if(!client.modmailDb.has(dmauthor.id))
                return interaction.reply({
                    content: "❌ **Você não tem mais um ticket !**",
                    ephemeral: true
                })
            let guild = client.guilds.cache.get(client.modmailDb.get(dmauthor.id, "id"));
            if(!guild) {
            ...
            if(!channel) {
                return interaction.reply({
                    embeds: [
                        ...
                        components: [
                            new Discord.MessageActionRow().addComponents(
                                new Discord.MessageButton().setStyle("SECONDARY").setLabel("Feche o ticket").setCustomId("force_modmail_close").setEmoji("❎")
                            )
                        ],
                        ephemeral: true
                }).catch(console.error)
            ...
            await dmauthor.send({
                ...
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                        .setColor("GREEN")
                        .setTitle("✅ Ticket  fechado `Veja toda a conversa nesse arquivo` ")
                    ]
            }).catch(console.error)
            await channel.send({
                files: attachment,
        ...
        if(interaction.isButton() && interaction.customId == "force_modmail_close" && !interaction.guildId){
            ...
            interaction.reply({
                content: "**Ticket fechado , agora você pode criar novos !**",
                ephemeral: true
            })
        }
        if(interaction.isButton() && interaction.customId == "close_modmail_ticket" && interaction.guildId){
            ...
            return interaction.reply({
                    embeds: [
                        new Discord.MessageEmbed()
                            ...
                            .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                            .setColor("RED")
                            .setTitle("❌ Esse canal foi fechado / o usuario saiu")
                            .setDescription(`Use: \`${config.prefix}fechar\`\nPara deletar o canal!`)
                        ]
                }).catch(console.error);
                ...
                return interaction.reply({
                    embeds: [
                        new Discord.MessageEmbed()
                            ...
                            .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                            .setColor("RED")
                            .setTitle("❌ A pessoa saiu do servidor")
                            .setDescription(`Feche o ticket com: \`${config.prefix}fecharticket\``` `)
                        ]
                }).catch(console.error)
            })
            ...
            await author.send({
                ...
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                        .setColor("GREEN")
                        .setTitle("✅  Alguem da `administração` fechou o ticket \n Veja toda conversa nesse arquivo.")
                    ]
            }).catch(console.error)
            ...
            await interaction.message.reply({
                ...
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setDescription(`você não pode fechar esse ticket novamente !`)
                    ]
            }).catch(console.error)
    ...
    function startSupportProcess(guild, message, dmauthor){
        client.modmailDb.ensure(guild.id, {
            enabled: false,
            category: null,
            message: "Aguarde a Staff te atender."
        })
            ...
            return message.reply({
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setDescription(`an admin can do it with \`${config.prefix}configurar\``)
                ]
            }).catch(console.error)
        }
        ...
        guild.channels.create(`${dmauthor.username}`.substr(0, 32) , {
            type: "GUILD_TEXT",
            topic: `Modmail aberto pelo: ${dmauthor.tag} | ${dmauthor.id}`,
            ...
            message.reply({
                embeds: [
                    ...
                    .addField("Segurança", ` Somente administradores podem ver suas mensagem`)
                   ],
                   components: [ new Discord.MessageActionRow().addComponents(new Discord.MessageButton()
                    .setStyle("DANGER").setEmoji("📝").setLabel("Fechar e Transcrever ").setCustomId("close_modmail_ticket"))]
            }).catch(console.error)
            channel.send({
                embeds: [
                    new Discord.MessageEmbed()
            ...
            return message.reply({
                embeds: [
                    ...
                    .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                    .setColor("RED")
                    .setTitle("❌ Falha ao criar seu ticket! | CANCELADO")
                    .setDescription(`\`\`\`${error.message ? String(error.message).substr(0, 2000) : String(e).substr(0, 2000)}\`\`\``)
                   ]
            }).catch(console.error)
        })
    ...
    return new Promise(async (resolve, reject) => {
      try{
        ...
        baseHTML += `<body><div class="info"><div class="guild-icon-container"> <img class="guild-icon" src="${Guild.iconURL({dynamic:true})}" />` +
          ...
          baseHTML += `<div class="message-group"><div class="ath-av-container"><img class="ath-av"src="https://logosmarken.com/wp-content/uploads/2020/12/Discord-Logo.png" /></div><div class="messages"><span class="ath-name" style="color: #00000b;">Discord Logs</span><span class="bot-tag">✓ SYSTEM</span><span class="timestamp"> </span><div class="message " ><div class="content"><div class="markdown"><span class="preserve-whitespace"><i><blockquote>Todos esses arquivos / midia do suporte não foram salvos pelo bot , apenas quem criou/staff consegue ver essa midia/arquivos</blockquote></i></span></div></div></div></div></div></div></body></html>`;
